...
//one at a time.
let friends_names = ["Azan", "Anus", "Huzaif", "Yousuf", "Mavi", "Tanzeel",];
friends_names.forEach(function (names) { console.log(names); });
...
let friends_name = ["Azan", "Anus", "Huzaif", "Yousuf", "Mavi", "Tanzeel",];
friends_name.forEach((names) => console.log(`Hello ${names}, How are you doing today?`));
export {};
