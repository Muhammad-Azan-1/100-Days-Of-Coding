...
guests.forEach(function (guest) { console.log(`Hello ${guest}, I would like to invite you to dinner.`); });
...
guests.forEach(function (guest) { console.log(`Hello ${guest}, You  are still invited  to dinner.`); });
guests.splice(0, 2);
console.log(guests);
// 15) Seeing the World: Think of at least five places you’d like to visit.
let world = ["Yemen", "Turky", "India", "Saudia Arabia", "Palestine",];
